...
> Άνοιγμα αυτής της σελίδας στο [https://okirioskliklikos.github.io/pxt-robitzero-base/](https://okirioskliklikos.github.io/pxt-robitzero-base/)
...
* αναζήτηση για **https://github.com/okirioskliklikos/pxt-robitzero-base** και εισαγωγή
...
* επικολλήστε **https://github.com/okirioskliklikos/pxt-robitzero-base** και κάντε κλικ στην εισαγωγή
